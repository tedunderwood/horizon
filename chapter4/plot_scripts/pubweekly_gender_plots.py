...
# To run this, you will first need to unpack some files in
# data_for_chapter4b.tar.gz, and put them in the ../data/ directory.
...
read(['../data/post22_character_data.csv', '../data/pre23_character_data.csv'])
