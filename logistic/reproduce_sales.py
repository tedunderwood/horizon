...
def genre_gridsearch(modelname, c_range, ftstart, ftend, ftstep, positive_tags = ['best'], negative_tags = ['elite', 'vulgar'], excl_below = 1700, excl_above = 2000):
    ...
    extension = '.tsv'
    metadatapath = '/Users/tunder/Dropbox/GenreProject/python/reception/sales/orthogonalbestsellers.csv'
    ...
    outputpath = '/Users/tunder/Dropbox/GenreProject/python/reception/sales/' + modelname + '.csv'
...
if __name__ == '__main__':
    ...
    if len(args) < 2:
        ...
        c_range = [.00009, .0002, .0004, .0008, .0012, .002, .004, .01, .03, 0.1]
        featurestart = 2000
        featureend = 6000
        featurestep = 200
        genre_gridsearch('salesvsreviews', c_range, featurestart, featureend, featurestep)
